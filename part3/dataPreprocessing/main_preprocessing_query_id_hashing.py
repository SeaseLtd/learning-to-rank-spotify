import getopt
import sys
from part3.dataPreprocessing import preprocessing_query_id_hashing
...
def main(argv):
    ...
    for currentArgument, currentValue in arguments:
        if currentArgument in ("-h", "--help"):
            print("'main_preprocessing_query_id_hashing.py -o <output_dir> -d <dataset_path> -e <encoding>'")
            sys.exit(1)
    ...
    preprocessing_query_id_hashing.preprocessing_query_id_hashing(*args1)
