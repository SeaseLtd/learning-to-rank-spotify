import getopt
import sys
from part3.modelTraining import training_check_intersections


def main(argv):
    unix_options = "ho:t:s:n:e:"
    gnu_options = ["help", "output_dir=","training_set=", "test_set=", "model_name=", "eval_metric="]
    args1 = []
    ...
    for currentArgument, currentValue in arguments:
        if currentArgument in ("-h", "--help"):
            print("'main_training_check_intersections.py -o <output_dir> -t <training_set> -s <test_set> -n <model_name> -e <eval_metric>'")
            sys.exit(1)
    ...
    training_check_intersections.train_model(*args1)
