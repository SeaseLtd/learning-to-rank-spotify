import getopt
import sys
from part3.trainingSetBuilder import training_set_builder_new_split_random
...
def main(argv):
    ...
    for currentArgument, currentValue in arguments:
        if currentArgument in ("-h", "--help"):
            print("'main_training_set_builder_new_split_random.py -o <output_dir> -d <dataset_name> -r <relevance_label_number> -s <test_set_size> -t <query_id_sample_threshold>'")
            sys.exit(1)
    ...
    training_set_builder_new_split_random.training_set_builder(*args1)
